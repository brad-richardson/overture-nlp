...
docker run --detach --gpus all -v ./models:/models -p 8080:8080 ghcr.io/ggml-org/llama.cpp:server-cuda -m /models/$MODEL_FILENAME --host 0.0.0.0 --port 8080 --ctx-size 16384 --parallel 4 --n-gpu-layers 33
